...
echo $ThisFileInfo['tags_html']['id3v1']['title'][0];  // title from ID3v2
echo $ThisFileInfo['tags_html']['id3v1']['artist'][0];  // title from ID3v2
echo $ThisFileInfo['tags_html']['id3v1']['album'][0];  // title from ID3v2
